...
class Solution:
    def canEat(self, candiesCount: List[int], queries: List[List[int]]) -> List[bool]:
        ...
        for ft, fd, dc in queries:
            # print(ft, prefxsum[ft-1], fd, dc, fd*dc)
            if ft and fd*dc < prefxsum[ft-1]:
                result.append((fd+1)*dc > prefxsum[ft-1])
            else:
                result.append(prefxsum[ft] >= fd+1)
        return result

S = Solution()

print(S.canEat([46,5,47,48,43,34,15,26,11,25,41,47,15,25,16,50,32,42,32,21,36,34,50,45,46,15,46,38,50,12,3,26,26,16,23,1,4,48,47,32,47,16,33,23,38,2,19,50,6,19,29,3,27,12,6,22,33,28,7,10,12,8,13,24,21,38,43,26,35,18,34,3,14,48,50,34,38,4,50,26,5,35,11,2,35,9,11,31,36,20,21,37,18,34,34,10,21,8,5],
